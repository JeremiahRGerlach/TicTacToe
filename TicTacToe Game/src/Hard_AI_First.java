public class Hard_AI_First 
    ...
    public static void hardAITurnSecond()
      {
      checkWin();
      checkBlock();
      playCenter();
        ...
        if (counter == 4) 
          ...
          for (int i = 0; i < 3; i++) 
            ...
            if (Universal_Methods.myMatrix[i][i].equals(" ")) 
              {
            	Universal_Methods.myMatrix[i][i] = "X";
            	Universal_Methods.myMatrix2[i][i] = 2;
            	Universal_Methods.playCount++;
            	Universal_Methods.foundMove = true;
              return;
              }
      ...
      if (counter == 4) 
        ...
        for (int i = 0; i < 3; i++) 
          ...
          if (Universal_Methods.myMatrix[i][2 - i].equals(" ")) 
            {
        	  Universal_Methods.myMatrix[i][2 - i] = "X";
        	  Universal_Methods.myMatrix2[i][i] = 2;
        	  Universal_Methods.playCount++;
        	  Universal_Methods.foundMove = true;
            return;
        ...
        if (counter == 10) 
          ...
          for (int i = 0; i < 3; i++) 
            ...
            if (Universal_Methods.myMatrix[i][i].equals(" ")) 
              {
            	Universal_Methods.myMatrix[i][i] = "X";
            	Universal_Methods.myMatrix2[i][2 - i] = 2;
            	Universal_Methods.playCount++;
            	Universal_Methods.foundMove = true;
              return;
              }
    ...
    public static void playCenter()
      ...
      if(Universal_Methods.foundMove == false)
        ...
        if(Universal_Methods.myMatrix[1][1].equals(" "))
          {
        	Universal_Methods.myMatrix[1][1] = "X";
        	Universal_Methods.myMatrix2[1][1] = 2;
        	Universal_Methods.playCount++;
        	Universal_Methods.foundMove = true;
          return;
          }
